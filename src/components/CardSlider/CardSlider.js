...
const CardSlider = ({ posts }) => {
  ...
  return (
    <div className='other-news-cards'>
      ...
      <NewsCard to={`/news/${posts[currentView + 1].slug}`} createdAt={posts[currentView + 1].createdAt} post={posts[currentView + 1]}></NewsCard>
      <NewsCard to={`/news/${posts[currentView + 2].slug}`} createdAt={posts[currentView + 2].createdAt} post={posts[currentView + 2]}></NewsCard>
